...
export function installTyping(mesh,text,context,width){
 // Measure with the exact font used to draw this localized canvas.
 ...
 const cut=mesh.userData.typing?.cut??{value:1};cut.value=1;mesh.userData.typing={text,widths,total,cut,width};
